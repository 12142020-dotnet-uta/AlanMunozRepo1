                ...
                do 
                {
                    ...
                    if (GameContext.myInterfaceOptions == InterfaceOptions.Play3Rounds)
                    {
                        ...
                        do
                        {
                            ...
                            Console.WriteLine($"You are in round #{match.lstRounds.Count + 1}, choose your fate:\n\t1.-Rock\n\t2.-Paper\n\t3.-Scissors");
                            ...
                            Console.WriteLine($"The result of round #{match.lstRounds.Count}:\t{round.WinnerRoundMessage()}");//with ID {round.RoundID}
